                ...
                <div class="modal-body">
                    <form method="POST" action="{{ route('sales') }}">
                        ...
                        <div class="row form-row">
                            <div class="col-12">
                                {{-- alert warning perhatikan stok obat --}}
                                <div class="alert alert-warning alert-dismissible fade show" role="alert">
                                    <strong>Peringatan!</strong> Tolong cek kuantitas produk sebelum input Quantity.
                                    {{-- <button type="button" class="close" data-dismiss="alert" aria-label="Close">
									<span aria-hidden="true">&times;</span>
								</button> --}}
                                </div>
                                            ...
                                            @if (!empty($product->purchase))
                                                ...
                                                @else
                                                    <option value="{{ $product->id }}" disabled>
                                                        {{ $product->purchase->name }} (Out of Stock)</option>
                                                @endif
                                            @endif
                                        @endforeach
                                    </select>
